...
ALTER TABLE ADDRESS ADD CONSTRAINT PERSONAL_INFO_ADDRESS_FK FOREIGN KEY (PERSONAL_INFO_ID) REFERENCES PERSONAL_INFO (PERSONAL_INFO_ID) ON DELETE CASCADE;
ALTER TABLE CLASS_BOOK ADD CONSTRAINT STUDENT_CLASS_BOOK_FK FOREIGN KEY (STUDENT_ID) REFERENCES STUDENT (STUDENT_ID) ON DELETE CASCADE;
